      ...
      <td>
        <table class="content-content" width="400" cellspacing="0" cellpadding="0" border="0" align="center">
          <tbody>
            <tr>
              <td align="center">
              	Bienvenido, hemos recibido una invitación para ti. Por favor, clica en el botón de abajo para aceptarla y formar parte de tu empresa. No olvides que, por defecto, tu contraseña inicial es 123456.
              </td>
            </tr>
            <tr>
              <td height="50"></td>
...
$returnsuccess = "https://app.cuantime.es/equip.php?event=newUser-success";
$returnfail = "https://app.cuantime.es/equip.php?event=newUser-email-fail";
?>